...
} from './pages/admin-select-church/admin-select-church-header/admin-select-church-header.component';
import {
  AdminSelectChurchListComponent
} from './pages/admin-select-church/admin-select-church-list/admin-select-church-list.component';
import {
  AdminSelectChurchItemComponent
} from './pages/admin-select-church/admin-select-church-item/admin-select-church-item.component';
import {
